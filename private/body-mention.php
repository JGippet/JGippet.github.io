...
<div class="text-center ">
  <h2 class="mb-5 mt-5">Mentions légales</h2>
</div>
<div class="container">
  <div id="mentionslegalesrgpd">
  				...
  				<div id="mentionslegales">
  					...
  					du Code civil, ou personne morale, qui visite le Site objet des présentes conditions générales.</p>
  					...
  					des données personnelles susceptibles d’être détenues par <?php echo $url; ?> pour
  					...
  					<p>Les termes « données à caractère personnel », « personne concernée », « sous traitant » et
  					...
  					numérique, il est précisé aux utilisateurs du site internet <?php echo $url; ?> l'identité
  					des différents intervenants dans le cadre de sa réalisation et de son suivi:</p>

  					<p><b>Propriétaire</b> : <?php echo $titre; ?> – <?php echo $adresseligne; ?> - <?php echo $tel; ?> - SIRET <?php echo $siret; ?> - RCS <?php echo $rcs; ?><br/>
  					<b>Responsable publication</b> : <?php echo $titre; ?> <?php echo $gerant; ?> – <?php echo $mail; ?>	<br/>
  					Le responsable publication est une personne physique ou une personne morale.</p><br/>
  					<p><b>Webmaster</b> : Pia</p><br/>
  					<p><b>Délégué à la protection des données</b> : <?php echo $titre; ?> – <?php echo $mail; ?></p>

  					<p>Ces mentions légales RGPD sont issues du générateur de mentions légales RGPD d'Orson.io</p>
  					...
  					<p>L’utilisation du site <?php echo $url; ?> implique l’acceptation pleine et entière
  					des conditions générales d’utilisation ci-après décrites. Ces conditions d’utilisation sont
  					susceptibles d’être modifiées ou complétées à tout moment, les utilisateurs du site <?php echo $url; ?>
  					sont donc invités à les consulter de manière régulière.	</p>

  					<p>Ce site internet est normalement accessible à tout moment aux utilisateurs. Une interruption
  					pour raison de maintenance technique peut être toutefois décidée par <?php echo $url; ?>,
  					qui s’efforcera alors de communiquer préalablement aux utilisateurs les dates et heures de
  					l’intervention. Le site web <?php echo $url; ?> est mis à jour régulièrement par
  					<?php echo $url; ?> responsable. De la même façon, les mentions légales peuvent
  					...
  					<p>Le site internet <?php echo $url; ?> a pour objet de fournir une information concernant
  					l’ensemble des activités de la société. <?php echo $url; ?> s’efforce de fournir
  					sur le site <?php echo $url; ?> des informations aussi précises que possible. Toutefois,
  					...
  					<p>Toutes les informations indiquées sur le site <?php echo $url; ?> sont données à
  					titre indicatif, et sont susceptibles d’évoluer. Par ailleurs, les renseignements figurant
  					sur le site <?php echo $url; ?> ne sont pas exhaustifs. Ils sont donnés sous réserve
  					...
  					de dernière génération mis-à-jour Le site <?php echo $url; ?> est hébergé chez un
  					...
  					<p><?php echo $url; ?> et l’hébergeur ne pourront être tenus responsables en cas de
  					dysfonctionnement du réseau Internet, des lignes téléphoniques ou du matériel informatique
  					et de téléphonie lié notamment à l’encombrement du réseau empêchant l’accès au serveur.</p>	


  					<h2>5. Propriété intellectuelle et contrefaçons.</h2>

  					<p><?php echo $url; ?> est propriétaire des droits de propriété intellectuelle et détient
  					...
  					procédé utilisé, est interdite, sauf autorisation écrite préalable de : <?php echo $url; ?>.</p>
  					...
  					<p><?php echo $url; ?> agit en tant qu’éditeur du site. <?php echo $url; ?>
  					est responsable de la qualité et de la véracité du Contenu qu’il publie.</p>

  					<p><?php echo $url; ?> ne pourra être tenu responsable des dommages directs et indirects
  					causés au matériel de l’utilisateur, lors de l’accès au site internet <?php echo $url; ?>,
  					...
  					<p><?php echo $url; ?> ne pourra également être tenu responsable des dommages indirects
  					(tels par exemple qu’une perte de marché ou perte d’une chance) consécutifs à l’utilisation
  					du site <?php echo $url; ?>. Des espaces interactifs (possibilité de poser des questions
  					dans l’espace contact) sont à la disposition des utilisateurs. <?php echo $url; ?>
  					...
  					relatives à la protection des données. Le cas échéant, <?php echo $url; ?> se réserve
  					...
  					que soit le support utilisé (texte, photographie …).</p>

  					<h2>7. Gestion des données personnelles.</h2>

  					<p>Le Client est informé des réglementations concernant la communication marketing, la loi du
  					21 Juin 2014 pour la confiance dans l’Economie Numérique, la Loi Informatique et Liberté du
  					06 Août 2004 ainsi que du Règlement Général sur la Protection des Données (RGPD : n° 2016-679).</p>
  					...
  					est : <?php echo $titre; ?>. <?php echo $url; ?> est représenté par <?php echo $gerant; ?>, son représentant
  					légal.</p>

  					<p>En tant que responsable du traitement des données qu’il collecte, <?php echo $url; ?>
  					...
  					de leurs données personnelles et de maintenir un registre des traitements conforme à la réalité.</p>
  					<p>Chaque fois que <?php echo $url; ?> traite des Données Personnelles, <?php echo $url; ?>
  					prend toutes les mesures raisonnables pour s’assurer de l’exactitude et de la pertinence des
  					Données Personnelles au regard des finalités pour lesquelles <?php echo $url; ?>
  					les traite.</p>

  					<h3>	7.2 Finalité des données collectées	</h3>


  					<p><?php echo $url; ?> est susceptible de traiter tout ou partie des données :</p>	
						<ul>
  					    <li>- pour permettre la navigation sur le Site et la gestion et la traçabilité des prestations
  					    ...
  					    <li>- pour mener des enquêtes de satisfaction facultatives sur <?php echo $url; ?> : adresse email	</li>

  					   <li> - pour mener des campagnes de communication (sms, mail) : numéro de téléphone, adresse email</li>
						  </ul>
  					<p><?php echo $url; ?> ne commercialise pas vos données personnelles qui sont donc
  					uniquement utilisées par nécessité ou à des fins statistiques et d’analyses.</p>

  					<h3>7.3 Droit d’accès, de rectification et d’opposition</h3>


  					<p>Conformément à la réglementation européenne en vigueur, les Utilisateurs de <?php echo $url; ?>
...
<ul>
  					   ...
  					   <li> - droit de définir le sort des données des Utilisateurs après leur mort et de choisir à qui
  					     <?php echo $url; ?> devra communiquer (ou non) ses données à un tiers qu’ils
  					     aura préalablement désigné	</li>
						   </ul>

  					<p>Dès que <?php echo $url; ?> a connaissance du décès d’un Utilisateur et à défaut
  					d’instructions de sa part, <?php echo $url; ?> s’engage à détruire ses données,
  					sauf si leur conservation s’avère nécessaire à des fins probatoires ou pour répondre à une
  					obligation légale.</p>

  					<p>Si l’Utilisateur souhaite savoir comment <?php echo $url; ?> utilise ses Données
  					Personnelles, demander à les rectifier ou s’oppose à leur traitement, l’Utilisateur peut contacter
  					<?php echo $url; ?> par écrit à l’adresse suivante :
  					  <?php echo $titre; ?> – DPO <?php echo $titre; ?>	<br/>
  					<?php echo $adresse; ?>. </p> 

  					<p>Dans ce cas, l’Utilisateur doit indiquer les Données Personnelles qu’il souhaiterait que <?php echo $url; ?>
  					corrige, mette à jour ou supprime, en s’identifiant précisément avec une copie d’une pièce d’identité
  					(carte d’identité ou passeport).</p>

  					<p>Les demandes de suppression de Données Personnelles seront soumises aux obligations qui sont
  					imposées à <?php echo $url; ?> par la loi, notamment en matière de conservation ou
  					d’archivage des documents. Enfin, les Utilisateurs de <?php echo $url; ?> peuvent
  					déposer une réclamation auprès des autorités de contrôle, et notamment de la CNIL (https://www.cnil.fr/fr/plaintes).</p>

  					<h3>7.4 Non-communication des données personnelles</h3>

  					<p><?php echo $url; ?> s’interdit de traiter, héberger ou transférer les Informations
  					...
  					autant, <?php echo $url; ?> reste libre du choix de ses sous-traitants techniques
  					et commerciaux à la condition qu’il présentent les garanties suffisantes au regard des exigences
  					du Règlement Général sur la Protection des Données (RGPD : n° 2016-679).</p>

  					<p><?php echo $url; ?> s’engage à prendre toutes les précautions nécessaires afin de
  					...
  					des Informations du Client est portée à la connaissance de <?php echo $url; ?>,
  					celle-ci devra dans les meilleurs délais informer le Client et lui communiquer les mesures
  					de corrections prises. Par ailleurs <?php echo $url; ?> ne collecte aucune « données
  					sensibles ».</p>

  					<p>Les Données Personnelles de l’Utilisateur peuvent être traitées par des filiales de <?php echo $url; ?>
  					et des sous-traitants (prestataires de services), exclusivement afin de réaliser les finalités
  					de la présente politique.</p>

  					<p>Dans la limite de leurs attributions respectives et pour les finalités rappelées ci-dessus,
  					les principales personnes susceptibles d’avoir accès aux données des Utilisateurs de <?php echo $url; ?>
  					sont principalement les agents de notre service client.</p>

  					<h2>8. Notification d’incident	</h2>

  					<p>Quels que soient les efforts fournis, aucune méthode de transmission sur Internet et aucune
  					...
  					<p>Aucune information personnelle de l'utilisateur du site <?php echo $url; ?> n'est
  					publiée à l'insu de l'utilisateur, échangée, transférée, cédée ou vendue sur un support quelconque
  					à des tiers. Seule l'hypothèse du rachat de <?php echo $url; ?> et de ses droits
  					...
  					l'utilisateur du site <?php echo $url; ?>.</p>


  					<h3>Sécurité	</h3>

  					<p>Pour assurer la sécurité et la confidentialité des Données Personnelles et des Données Personnelles
  					de Santé, <?php echo $url; ?> utilise des réseaux protégés par des dispositifs standards
  					tels que par pare-feu, la pseudonymisation, l’encryption et mot de passe.</p>

  					Lors du traitement des Données Personnelles, <?php echo $url; ?> prend toutes les
  					...
  					<p>Le site <?php echo $url; ?> contient un certain nombre de liens hypertextes vers
  					d’autres sites, mis en place avec l’autorisation de <?php echo $url; ?>. Cependant,
  					<?php echo $url; ?> n’a pas la possibilité de vérifier le contenu des sites ainsi
  					...
  					ou empêcher l’accessibilité à tout ou partie des Services proposés par le site.</p>

  					<h3>9.1. « COOKIES »</h3>


  					<p>Un « cookie » est un petit fichier d’information envoyé sur le navigateur de l’Utilisateur
  					...
  					<p><?php echo $url; ?> est susceptible de traiter les informations de l’Utilisateur
  					concernant sa visite du Site, telles que les pages consultées, les recherches effectuées.
  					Ces informations permettent à <?php echo $url; ?> d’améliorer le contenu du Site,
  					de la navigation de l’Utilisateur.</p>
  					...
  					dans son terminal. <?php echo $url; ?> informe l’Utilisateur que, dans ce cas, il
  					se peut que les fonctionnalités de son logiciel de navigation ne soient pas toutes disponibles.</p>

  					<p>Si l’Utilisateur refuse l’enregistrement de Cookies dans son terminal ou son navigateur, ou
  					...
  					<?php echo $url; ?> ou l’un de ses prestataires ne peut pas reconnaître, à des fins
  					...
  					<p>Le cas échéant, <?php echo $url; ?> décline toute responsabilité pour les conséquences
  					liées au fonctionnement dégradé du Site et des services éventuellement proposés par <?php echo $url; ?>,
  					résultant (i) du refus de Cookies par l’Utilisateur (ii) de l’impossibilité pour <?php echo $url; ?>
  					...
  					<p>À tout moment, l’Utilisateur peut faire le choix d’exprimer et de modifier ses souhaits en matière
  					de Cookies. <?php echo $url; ?> pourra en outre faire appel aux services de prestataires
  					externes pour l’aider à recueillir et traiter les informations décrites dans cette section.	</p>

  					<p>Enfin, en cliquant sur les icônes dédiées aux réseaux sociaux Twitter, Facebook, Linkedin et
  					Google Plus figurant sur le Site de <?php echo $url; ?> ou dans son application mobile
  					et si l’Utilisateur a accepté le dépôt de cookies en poursuivant sa navigation sur le Site
  					Internet ou l’application mobile de <?php echo $url; ?>, Twitter, Facebook, Linkedin
  					et Google Plus peuvent également déposer des cookies sur vos terminaux (ordinateur, tablette, téléphone portable).	</p>

  					<p>Ces types de cookies ne sont déposés sur vos terminaux qu’à condition que vous y consentiez,
  					en continuant votre navigation sur le Site Internet ou l’application mobile de <?php echo $url; ?>.
  					À tout moment, l’Utilisateur peut néanmoins revenir sur son consentement à ce que <?php echo $url; ?>
  					dépose ce type de cookies.</p>

  					<h3>Article 9.2. BALISES (“TAGS”) INTERNET</h3>

  					<p><?php echo $url; ?> peut employer occasionnellement des balises Internet (également
  					...
  					<p>Cette technologie permet à <?php echo $url; ?> d’évaluer les réponses des visiteurs
  					face au Site et l’efficacité de ses actions (par exemple, le nombre de fois où une page est ouverte
  					et les informations consultées), ainsi que l’utilisation de ce Site par l’Utilisateur.</p>

  					<p>Le prestataire externe pourra éventuellement recueillir des informations sur les visiteurs du Site
  					et d’autres sites Internet grâce à ces balises, constituer des rapports sur l’activité du Site
  					à l’attention de <?php echo $url; ?>, et fournir d’autres services relatifs à l’utilisation
  					de celui-ci et d’Internet.</p>

  					<h2>10. Droit applicable et attribution de juridiction.	</h2>

  					<p>Tout litige en relation avec l’utilisation du site <?php echo $url; ?> est soumis
  					au droit français. En dehors des cas où la loi ne le permet pas, il est fait attribution exclusive
  					de juridiction aux tribunaux compétents de <?php echo $rcs; ?></p>
